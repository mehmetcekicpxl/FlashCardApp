...
public class MatchingFragmentDirections private constructor() {
  private data class ActionMatchingFragmentToPracticeSummaryFragment(
    public val correctCount: Int,
    public val wrongCount: Int,
    public val durationMinutes: Int,
    public val practiceMode: String,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_matchingFragment_to_practiceSummaryFragment
  ...
  public companion object {
    public fun actionMatchingFragmentToPracticeSummaryFragment(
      correctCount: Int,
      wrongCount: Int,
      durationMinutes: Int,
      practiceMode: String,
    ): NavDirections = ActionMatchingFragmentToPracticeSummaryFragment(correctCount, wrongCount,
